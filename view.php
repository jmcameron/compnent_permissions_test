...
class PermtestView extends JViewLegacy
{
	...
	public static function showPermissions()
	{
		...
		$defaults = Array('core.admin' => 'core.admin (cannot be modified by this function)',
						  ...
						  'core.edit.own' => 'core.edit.own (cannot be modified by this function)',
						  'core.edit.state' => 'core.edit.state (cannot be modified by this function)',
						  'permtest.default' => 'No default give: Defaults to system default permissions (denied)',
						  'permtest.custom.registered1' => 'com_content:core.login.site',
						  'permtest.custom.registered2' => 'com_content:core.login.site[Registered]',
